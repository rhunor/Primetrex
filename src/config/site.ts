export const siteConfig = {
  ...
  description:
    "Earn money by referring others to Primetrex copy trading. Pay a one-time ₦10,000 signup fee, get your unique affiliate link, and earn 40% commissions every month.",
