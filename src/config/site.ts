export const siteConfig = {
  ...
  description:
    "Earn money by becoming an affiliate of Primetrex copy trading. Pay a one-time ₦10,000 signup fee, get your unique affiliate link, and earn 40% commissions every month.",
